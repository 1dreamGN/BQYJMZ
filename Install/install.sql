DROP TABLE IF EXISTS `bqyj_separate`;
CREATE TABLE IF NOT EXISTS `bqyj_separate` (
...
DROP TABLE IF EXISTS `bqyj_vips`;
CREATE TABLE IF NOT EXISTS `bqyj_vips` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bqyj_users` VALUES ('1', 'admin', '1', '1', null, '2020-12-30', '0', '127', '26ff3a5be026305db95aac0adc3ca352', '0b484609853c70cd87c8d1e3b2f5f34a', '9','1','0','1', '2302701417', '', '127.0.0.1', '127.0.0.1', '2016-07-31 10:33:39', '2016-07-31 10:33:44','','','0','2016-07-31');
INSERT INTO `bqyj_webconfigs` VALUES ('cronrand', '1234');
INSERT INTO `bqyj_webconfigs` VALUES ('name', '冰清玉洁秒赞网');
INSERT INTO `bqyj_webconfigs` VALUES ('introduce', '全网最大的秒赞平台,离线秒赞功能,自动点赞,空间签到发说说,商城点卡,自动充值自动发货,24小时离线秒赞平台');
INSERT INTO `bqyj_webconfigs` VALUES ('keyword', '冰清玉洁秒赞网，顾念秒赞网');
...
INSERT INTO `bqyj_webconfigs` VALUES ('zfnet', '3');
...
INSERT INTO `bqyj_webconfigs` VALUES ('shuogg', ' 冰清玉洁秒赞网');
INSERT INTO `bqyj_webconfigs` VALUES ('web_quanquanjk', '');
INSERT INTO `bqyj_webconfigs` VALUES ('webname', '冰清玉洁秒赞网');
...
INSERT INTO `bqyj_webconfigs` VALUES ('freevip', '1');
INSERT INTO `bqyj_webconfigs` VALUES ('web_ifreg', '1');
INSERT INTO `bqyj_webconfigs` VALUES ('web_iflogin', '1');
INSERT INTO `bqyj_webconfigs` VALUES ('email_user', '2302701417@qq.com');
INSERT INTO `bqyj_webconfigs` VALUES ('email_host', '');
INSERT INTO `bqyj_webconfigs` VALUES ('email_port', '');
INSERT INTO `bqyj_webconfigs` VALUES ('email_pwd', '');
INSERT INTO `bqyj_webconfigs` VALUES ('chaoren_user', '');
INSERT INTO `bqyj_webconfigs` VALUES ('chaoren_pwd', '');
