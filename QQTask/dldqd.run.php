...
$result = $db->query("SELECT * FROM {$prefix}qqs where qid='{$qid}' and isdldqd>0 and skeyzt=0 limit 1");
if ($row = $result->fetch(PDO::FETCH_ASSOC)) {
	...
	$db->query("update {$prefix}qqs set lastdldqd='$now',nextdldqd='$next' where qid='$qid'");
