...
$result = $db->query("SELECT * FROM {$prefix}qqs where qid='{$qid}' and isvipqd>0 and skeyzt=0 limit 1");
if ($row = $result->fetch(PDO::FETCH_ASSOC)) {
	...
	@$db->query("update {$prefix}qqs set {$sql}nextvipqd='$next' where qid='$qid'");
