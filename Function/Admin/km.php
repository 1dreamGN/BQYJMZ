			...
			<div class="panel-body">
				<div class="table-responsive">
					...
					<tr>
						...
						<td>
							<?php if($km['isuse']){echo'<font color="red">已使用</font>';}else{echo'<font color="green">未使用</font>';}?>
						</td>
						<td>
							<?=$km['usetime']?>
						</td>
						<td>
							<a href="?do=del&p=<?=$p?>&kid=<?=$km['kid']?>" class="btn btn-danger" onClick="if(!confirm('确认删除？')){return false;}">删除</a>&nbsp;
						</td>
					</tr>
					<?php }?>
					</tbody>
